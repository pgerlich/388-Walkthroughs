...
public class SecondActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityStack[activityStackIndex] = "Second Activity";
        activityStackIndex++;
    ...
    public void onRestart(){
        ...
        yell("Second Activity Restarted!");
    }
    ...
    public void onDestroy() {
        ...
        yell("Second Activity Destroyed!");
    }
    ...
    public void setupActivityStackVisualization(){
        LinearLayout linearLayout = (LinearLayout) findViewById(R.id.activity_stack_display_second);
