...
public class ToDoDBAdapter {
  ...
  public Cursor getPathsMatchingQuery(String query){
      //TODO: Doesn't work - you must have a column named w/ SearchManager.SUGGEST_COLUMN_TEXT_1 for the displayed text
    return db.query(DATABASE_TABLE, new String[] { KEY_ID, KEY_TASK}, "WHERE " + KEY_TASK + " Like ?", new String[] { query }, null, null, null);
  }
